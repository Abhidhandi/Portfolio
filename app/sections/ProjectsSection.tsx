...
const projects = [
    {
        title: "MockMind – AI Interview Prep",
        desc: "Full-stack AI interview platform with Google Auth, real-time question generation, and answer scoring.",
        fullDesc:
            "MockMind is a full-stack AI-powered mock interview platform. Users log in with Google, select a role, and receive AI-generated interview questions. Their answers are evaluated in real-time with a score and detailed feedback. Built with Next.js 14, TypeScript, Supabase for auth and database with Row Level Security, and Groq AI for question generation and evaluation. Fully deployed on Vercel.",
        tech: ["Next.js", "TypeScript", "Supabase", "Groq AI", "PostgreSQL"],
        github: "https://github.com/Abhidhandi/Mockmimd",
        live: "https://mockmimd-vj3o.vercel.app",
    },
    {
    ...
    },
    {
        ...
        github: "https://github.com/Abhidhandi/portfolio",
        live: "https://portfolio-eight-tau-71.vercel.app",
    },
]
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {projects.map((p, i) => (
                        ...
                        >
                            <div>
                                <h3 className="text-red-400 text-xl font-semibold mb-3">{p.title}</h3>
